...
//returneaza lacatul matricei din fabrica
...
//returneaza numarul existenti de elfi din fabrica in care suntem
    public int nrExistentiDeElfi() {
        return elfi.size();
    }
//returneaza dimensiunea matriceala a fabricii
    public int getN() {
        return N;
    }
//returneaza numarul fabricii
    public int getNumar() {
        return numar;
    }
    ...
    public void mutaElf(Elf elf) {
        ...
        try {
            ...
            // In fabrica se pot misca cate un elf pe rand
            fabricaLock.lock();
            ...
            if (mutareSpreDreapta(X, Y)) {
                ...
                // Daca un elf nu se poate misca din cauza ca este inconjurat prin toate partile
				//Se opreste din munca sa
                elf.stopWork();
            }
    ...
    private void askPositiaElfilor() {
        ...
        try {
            ...
            // intreaba elfii despre pozitia actuala
            fabricaLock.lock();
            listaElfiLock.lock();
            cadouriLock.lock();
